...
export class PostService {
  ...
  addPost(title:string, content:string, image:File) {
    ...
    this.http.post<{message:string, post:{ id: string; title: string; content: string, imagePath:string }}>(BACKEND_URL, postData)
  ...
  updatePost(id:string, title:string, content:string, image : File | string){
    ...
    this.http
    .put<{message:string,  imagePath:string}>(BACKEND_URL + id, postData)
    .subscribe((response) => {
        this.router.navigate(["/"]);
    })
  }
